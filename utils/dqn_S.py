...
class DQNAgent_S(nn.Module):
    """DQN agent for source-side coding decisions."""
    ...
    def create_q_network(self):
        """Create the source-side Q-network."""
    ...
    def load_network(self, path):
        """Load source policy parameters from file."""
    ...
    def save_network(self, path):
        """Save source policy parameters to file."""
